...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;margin:0 auto">
  <tr><td style="background:#111627;border-radius:14px;border:1px solid #1a1f35;padding:28px">
    ...
    <div style="margin-top:20px">
      <a href="${process.env.NEXT_PUBLIC_URL || "http://localhost:3000"}/admin" style="display:inline-block;padding:10px 18px;border-radius:8px;background:#587cff;color:#fff;font-size:13px;font-weight:600;text-decoration:none">View all signups →</a>
    </div>
  </td></tr>
</table>
</body>
